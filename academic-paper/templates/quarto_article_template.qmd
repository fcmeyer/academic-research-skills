...
# Keep affiliation IDs stable (aff-1, aff-2, ...) to reduce merge conflicts.
affiliations:
  - id: aff-1
    name: "[Department, Institution]"
...
# To change style, run `python scripts/bootstrap_csl.py` and set this path
# to your downloaded style file (for example: csl/ieee.csl).
csl: "csl/apa.csl"
...
format:
  pdf:
    ...
    include-in-header:
      text: |
        % Typography note: prefer Times-like serif for APA-style output.
        % CJK note: for zh-TW or bilingual manuscripts, use XeLaTeX + xeCJK and set an explicit CJK font.
  docx:
    toc: false
    number-sections: true
    reference-doc: "apa-reference.docx"

# Optional bilingual fields can be added for zh-TW workflows.
# abstract-zh: "[中文摘要內容]"
# keywords-zh: ["[關鍵詞一]", "[關鍵詞二]", "[關鍵詞三]"]
---
